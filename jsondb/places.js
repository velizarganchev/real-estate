    ...
    places: [
        {
            ...
            amenities: [
                ...
                { text: "Kitchen", icon: "fa-solid fa-utensils" },
                { text: "Free parking on premises", icon: "fa-solid fa-square-parking" },
                { text: "TV", icon: "fa-solid fa-tv" },
            ],
            images: [
        ...
        },
        {
            ...
            amenities: [
                ...
                { text: "Free parking on premises", icon: "fa-solid fa-square-parking" },
                { text: "TV", icon: "fa-solid fa-tv" },
                { text: "Pets allowed", icon: "fa-solid fa-paw" },
                { text: "EV charger", icon: "fa-solid fa-charging-station" }
            ],
            images: [
