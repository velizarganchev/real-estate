    ...
    places: [
        {
            ...
            amenities: [<i class="fa-solid fa-wifi"></i> + "Wifi", <i class="fa-solid fa-utensils"></i> + "Kitchen", <i class="fa-solid fa-square-parking"></i> + "Free parking on premises", <i class="fa-solid fa-tv"></i> + "TV", <i class="fa-solid fa-washing-machine"></i> + "Washer"],
            images: [
        ...
        },
        {
            ...
            amenities: [<i class="fa-solid fa-wifi"></i> + "Wifi", <i class="fa-solid fa-utensils"></i> + "Kitchen", <i class="fa-solid fa-square-parking"></i> + "Free parking on premises", <i class="fa-solid fa-tv"></i> + "TV", <i class="fa-solid fa-washing-machine"></i> + "Washer", <i class="fa-solid fa-umbrella-beach"></i> + "Public or shared beach access"],
            images: [
